...
import Hero from "./Search/Components-Search/Hero/Hero.jsx";
import CardsSection from "./Search/Components-Search/CardsSection/CardsSection.jsx";
import Pagination from "./Search/Components-Search/Pagination.jsx";
...
export function EmpleosPage() {
  ...
  return (
    <main className="flex flex-col gap-6 px-[15%] py-8 items-center">
      ...
      <CardsSection query={searchQuery} jobsJSON={pageResults} />
      <Pagination
